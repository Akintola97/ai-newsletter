...
import { Loader2, Sparkles, Tag, PauseCircle } from "lucide-react";
        ...
        <CardContent className="space-y-4">
            ...
            >
              {notice.type === "success" ? (
                <svg className="h-4 w-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path strokeWidth="2" d="M22 11.08V12a10 10 0 1 1-5.93-9.14" />
              ...
              <p className="leading-none truncate max-w-[70ch]">{notice.message}</p>
            </div>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              <Label>
                Topics{" "}
                <span className="text-xs text-muted-foreground">(comma separated, optional)</span>
              </Label>
