...
//           AI News delivered straight to your inbox.  
//           Choose <span className="font-semibold">daily</span>,{" "}
//           <span className="font-semibold">biweekly</span>, or{" "}
//           <span className="font-semibold">monthly</span> updates.
//         </p>
//         <LoginLink
//           className="inline-flex items-center px-6 py-3 rounded-2xl bg-primary text-primary-foreground font-medium shadow-md hover:shadow-lg transition-all duration-200"
//         >
//           Sign in with Kinde
//         </LoginLink>
//       </div>
...
export default async function Home() {
  ...
  if (await isAuthenticated()) {
    redirect("/dashboard"); // signed-in users never see "/"
  }
  return <HomeHero />;
}
